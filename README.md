...
```shell
python -m source.cifar10_code.dataset_1_creation
```
...
```shell
python -m source.mnist_code.dataset_1_creation
```
...
```shell
python -m source.fashion_mnist_code.dataset_1_creation
```
...
```shell
python -m source.cifar10_code.dataset_2_meta_info_preparation
```
...
```shell
python -m source.mnist_code.dataset_2_meta_info_preparation
```
...
```shell
python -m source.fashion_mnist_code.dataset_2_meta_info_preparation
```
...
```shell
python -m source.cifar10_code.dataset_3_data_preparation
```
...
```shell
python -m source.mnist_code.dataset_3_data_preparation
```
...
```shell
python -m source.fashion_mnist_code.dataset_3_data_preparation
```
